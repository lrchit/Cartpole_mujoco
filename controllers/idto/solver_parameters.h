...
struct SolverParameters {
  ...
  SolverParameters(YAML::Node config) {
    ...
    contact_stiffness = config["idto"]["contactModelParam"]["contact_stiffness"].as<double>();
    dissipation_velocity = config["idto"]["contactModelParam"]["dissipation_velocity"].as<double>();
    smoothing_factor = config["idto"]["contactModelParam"]["smoothing_factor"].as<double>();
    friction_coefficient = config["idto"]["contactModelParam"]["friction_coefficient"].as<double>();
    stiction_velocity = config["idto"]["contactModelParam"]["stiction_velocity"].as<double>();
    k_spring = config["idto"]["contactModelParam"]["k_spring"].as<double>();
    d_damper = config["idto"]["contactModelParam"]["d_damper"].as<double>();
    damper_smooth = config["idto"]["contactModelParam"]["damper_smooth"].as<double>();
    spring_smooth = config["idto"]["contactModelParam"]["spring_smooth"].as<double>();
    zOffset = config["idto"]["contactModelParam"]["zOffset"].as<double>();
    which_contact_model = config["idto"]["contactModelParam"]["which_contact_model"].as<double>();
